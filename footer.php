<div class="footer-rows" style="">
	...
	<ul>
		...
		<li class="github">
			<a href="https://github.com/jossafer96/Subete/" target="_blank">
  ...
  <h1 class="text">SUBETE!</h1>
  <h2 class="text2">&copy;	UNAH - DESIGNED BY GROUP ECONOMIA DIGITAL</h2>
  <h2 class="text3">Copyright © 2019. All rights reserved.</h2>
</footer>
